...
public class DoctorView extends JPanel {
    ...
    private void addMedicalRecord(ActionEvent e) {
        ...
        controller.openView("medical record", doctor, patientID);
    }

    private void initComponents(ArrayList<String> patientList) {
        ...
        patientListBox = new JComboBox(model);
